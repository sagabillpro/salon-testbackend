...
const repository = async () => {
  ...
  //1. find all records
  const find = async (option?: FindManyOptions<Branch>) => {
    try {
  ...
  const findOne = async (option?: FindOneOptions<Branch>) => {
    try {
      return await repo.find(option);
    } catch (error) {
      throw error;
  ...
  const findOneById = async (id: number, filter?: FindOneOptions<Branch>) => {
    try {
  ...
  const create = async (data: Branch) => {
    try {
  ...
  const updateById = async (id: number, data: Branch) => {
    try {
  ...
  const createAll = async (data: Branch[]) => {
    try {
      const respo = repo.create(data);
      await repo.save(respo);
      return respo;
  ...
  //6. create multiple records
  const createBulk = async (data: Branch[]) => {
    try {
      const respo = repo.create(data);
      await repo.save(respo);
