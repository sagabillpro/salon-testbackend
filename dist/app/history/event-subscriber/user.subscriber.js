...
var UsersSubscriber = /** @class */ (function () {
     ...
     */
    UsersSubscriber.prototype.beforeUpdate = function (event) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        history_1 = new history_entities_1.UsersHistory();
                        history_1.recordId = event.entity.id;
                        history_1.code = event.entity.code;
                        history_1.name = event.entity.name;
                        history_1.userName = event.entity.userName;
                        history_1.password = event.entity.password;
                        history_1.userTypeId = event.entity.userTypeId;
                        ...
                        return [4 /*yield*/, event.manager.insert(history_entities_1.UsersHistory, history_1)];
                    case 1:
                        // Insert the history record into the database.
                        // Copy any additional fields from the Company entity as needed.
                        // Use event.manager to insert the history record within the same transaction.
