...
router.post("/", (0, get_model_schema_util_1.validateRequestBody)(services_entity_1.Services), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, services_service_1.default.create(req.body)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _b = (_a = services_service_1.default).findById;
                _c = [id];
                return [4 /*yield*/, (0, get_query_util_1.default)(req, services_entity_1.Services)];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = Number(req.params.id);
                return [4 /*yield*/, services_service_1.default.updateById(id, req.body)];
            case 1:
                _a.sent();
                res.send();
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = Number(req.params.id);
                return [4 /*yield*/, services_service_1.default.deleteById(id)];
            case 1:
                _a.sent();
                res.send();
                return [3 /*break*/, 3];
...
exports.default = new routes_types_1.Route("/services", router);
