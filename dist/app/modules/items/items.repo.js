...
var repository = function () { return __awaiter(void 0, void 0, void 0, function () {
    var dataSource, itemRepository, find, findOne, findOneById, create, updateById, deleteById, createAll, createBulk;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, dbconfig_1.handler)()];
            case 1:
                dataSource = _a.sent();
                itemRepository = dataSource.getRepository(items_entity_1.Item);
                find = function (option) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, itemRepository.find(option)];
                ...
                findOneById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
                    var item, error_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                items = itemRepository.create(data);
                                return [4 /*yield*/, itemRepository.save(items)];
                            case 1:
                                _a.sent();
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, itemRepository.save(__assign(__assign({}, respo), data))];
                            case 2:
                                _a.sent();
                                return [3 /*break*/, 4];
                            case 3:
