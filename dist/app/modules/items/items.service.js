...
var items_repo_1 = __importDefault(require("./items.repo"));
//1. find multiple records
var find = function (filter) { return __awaiter(void 0, void 0, void 0, function () {
    var itemRepo, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, items_repo_1.default)()];
            case 1:
                itemRepo = _a.sent();
                return [2 /*return*/, itemRepo.find(filter)];
            case 2:
                error_1 = _a.sent();
                throw error_1;
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                itemRepo = _a.sent();
                return [4 /*yield*/, itemRepo.findOneById(id)];
            case 2:
                item = _a.sent();
...
var updateById = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, items_repo_1.default)()];
            case 1:
                itemRepo = _a.sent();
                return [4 /*yield*/, itemRepo.updateById(id, data)];
            case 2:
                _a.sent();
                try {
                }
...
var deleteById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                itemRepo = _a.sent();
                return [4 /*yield*/, itemRepo.deleteById(id)];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
