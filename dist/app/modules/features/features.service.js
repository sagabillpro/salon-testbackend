...
var features_repo_1 = __importDefault(require("./features.repo"));
...
var find = function (filter) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, features_repo_1.default)()];
            case 1:
                repo = _a.sent();
...
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                repo = _a.sent();
                return [4 /*yield*/, (0, get_object_code_util_1.generateCode)(28, data)];
            case 2:
                data = _a.sent();
