...
var service_session_service_1 = __importDefault(require("./service-session.service"));
...
router.get("/", (0, validate_filter_util_1.validateFilter)(sale_header_entity_1.SaleHeaders), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 3, , 4]);
                _b = (_a = service_session_service_1.default).find;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, service_session_service_1.default.create(req.body)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, service_session_service_1.default.updateById(id, req.body)];
            case 1:
                _a.sent();
                res.send();
                return [3 /*break*/, 3];
...
exports.default = new routes_types_1.Route("/service-sessions", router);
//# sourceMappingURL=service-session.routes.js.map