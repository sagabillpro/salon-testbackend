...
var feature_setting_repo_1 = __importDefault(require("./feature-setting.repo"));
...
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var dataSource, featureTypeRepo, menuRepo, ftype, menu, repo, respo, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 4:
                repo = _a.sent();
                respo = repo.create(__assign(__assign({}, data), { featureType: ftype, menu: menu }));
                return [2 /*return*/, respo];
            case 5:
                error_3 = _a.sent();
                throw error_3;
...
//# sourceMappingURL=feature-setting.service.js.map