    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = 1;
                return [4 /*yield*/, taxes_service_1.default.calculateGstReport(id)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
//   }
// );
exports.default = new routes_types_1.Route("/gst-report", router);
//# sourceMappingURL=tax-report.route.js.map