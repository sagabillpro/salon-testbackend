    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                worksheet = (0, get_report_headers_util_1.getWorksheetColumnsFromSchema)(13, worksheet, result);
                // 5. Stream the Excel file as a response
                res.setHeader("Content-Type", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
                res.setHeader("Content-Disposition", "attachment; filename=service-sale-revenue-report".concat(Date.now(), ".xlsx"));
