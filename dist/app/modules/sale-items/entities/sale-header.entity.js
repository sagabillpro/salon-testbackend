...
var SaleHeaders = /** @class */ (function () {
    ...
    SaleHeaders_1 = SaleHeaders;
    SaleHeaders.prototype.generateRecordId = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        dataSource = _a.sent();
                        return [4 /*yield*/, dataSource.getRepository(SaleHeaders_1).findOne({
                                where: {},
                                order: { recordId: "DESC" },
                            })];
                    case 2:
    ...
    __decorate([
        (0, typeorm_1.Column)({ type: "int", nullable: true }),
        __metadata("design:type", Number)
    ], SaleHeaders.prototype, "recordId", void 0);
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return user_entity_1.Users; }),
        (0, typeorm_1.JoinColumn)(),
        __metadata("design:type", user_entity_1.Users)
