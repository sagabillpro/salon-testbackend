...
var customer_repo_1 = __importDefault(require("./customer.repo"));
...
var find = function (filter) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, customer_repo_1.default)()];
            case 1:
                repo = _a.sent();
...
var updateById = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                data = _a.sent();
                respo = repo.updateById(id, __assign(__assign({}, data), { city: city, state: state, country: country }));
                return [2 /*return*/, respo];
            case 7:
                error_4 = _a.sent();
                throw error_4;
