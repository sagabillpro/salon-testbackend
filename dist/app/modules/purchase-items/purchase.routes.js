...
var purchase_service_1 = __importDefault(require("./purchase.service"));
...
router.post("/", (0, validate_req_body_util_1.validateBodyManual)(schema_1.PurchaseHeadersSchema), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, purchase_service_1.default.create(req.body)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _b = (_a = purchase_service_1.default).findById;
                _c = [id];
                return [4 /*yield*/, (0, get_query_util_1.default)(req, purchase_headers_entity_1.PurchaseHeaders)];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = Number(req.params.id);
                return [4 /*yield*/, purchase_service_1.default.updateById(id, req.body)];
            case 1:
                _a.sent();
                res.send();
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = Number(req.params.id);
                return [4 /*yield*/, purchase_service_1.default.deleteById(id)];
            case 1:
                _a.sent();
                res.send();
                return [3 /*break*/, 3];
